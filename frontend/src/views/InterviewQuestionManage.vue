  ...
  setup() {
    ...
    const fetchQuestions = async () => {
      ...
      try {
        ...
        const res = await request.get('/api/admin/interview-questions', { params })
    ...
    const fetchCompanyOptions = async () => {
      try {
        const res = await request.get('/api/companies/enabled')
        if (res.code === 200) {
    ...
    const fetchCategoryOptions = async () => {
      try {
        const res = await request.get('/api/company-question-categories/enabled')
        if (res.code === 200) {
    ...
    const deleteQuestion = async (question) => {
      try {
        ...
        await request.delete(`/api/admin/interview-questions/${question.id}`)
    ...
    const saveQuestion = async () => {
      try {
        ...
        const payload = {
          id: questionForm.id || null,
          companyId: questionForm.companyId,
        ...
        await request.post('/api/admin/interview-questions', payload)
